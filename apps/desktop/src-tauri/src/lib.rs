...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            agent_bridge::commands::agent_set_session_model,
            ...
            agent_bridge::ollama::ollama_status,
            agent_bridge::ollama::ollama_list_models,
            agent_bridge::ollama::ollama_pull,
            ...
            agent_bridge::commands::agent_test_mcp_server,
