...
> **Godcoder has been reimagined from the ground up.** The original (2024)
> autonomous-dev pipeline is frozen under [`v1/`](./v1) — preserved, not
> maintained or built.

## What Godcoder can do

- Run in **Ask**, **Plan**, and **Coding** modes for different levels of autonomy.
- Edit files in place, review diffs, rewind to checkpoints, and continue from
  previous turns without leaving the desktop app.
- Use an interactive **terminal**, **file explorer**, and session history to work
  through changes step by step.
...
- Keep the workflow **local-first** with tool approval controls, subagents, and
  skills for more deliberate execution.
...
Godcoder works the moment you add an LLM key — in-place edits,
